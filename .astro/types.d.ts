...
"what-does-it-mean-to-dream-about-a-house.md": {
	id: "what-does-it-mean-to-dream-about-a-house.md";
  slug: "what-does-it-mean-to-dream-about-a-house";
  body: string;
  collection: "blog";
  data: any
} & { render(): Render[".md"] };
...
"what-does-it-mean-to-dream-with-diamonds.md": {
	id: "what-does-it-mean-to-dream-with-diamonds.md";
  slug: "what-does-it-mean-to-dream-with-diamonds";
  body: string;
  collection: "blog";
  data: any
} & { render(): Render[".md"] };
