...
export async function GET({ request, cookies }: APIContext) {
  ...
  try {
    ...
    formData.append("client_id", import.meta.env.GOOGLE_AUTH_CLIENT_ES);
    formData.append("client_secret", import.meta.env.GOOGLE_AUTH_SECRET_ES);
    formData.append("redirect_uri", import.meta.env.GOOGLE_AUTH_CALLBACK_URL_ES);
