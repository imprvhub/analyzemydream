...
export async function GET({ request, cookies }: APIContext) {
  ...
  try {
    ...
    formData.append("client_id", import.meta.env.GOOGLE_AUTH_CLIENT_BR);
    formData.append("client_secret", import.meta.env.GOOGLE_AUTH_SECRET_BR);
    formData.append("redirect_uri", import.meta.env.GOOGLE_AUTH_CALLBACK_URL_BR);
